    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (continuar) {
            ...
            if (opcion == 1) {
                ...
                if(servUsuario.Info_UsuarioLogin(con, username, password)){
                ...
                while(w==1){
                    ...
                    switch(opcionseccion){
                        ...
                        case 2: System.out.println("Digite la base de su cuarto en metros: ");
                            ...
                            Room diseño = new Room(base, altura, profundidad, "hola");
                            servRoom.guardar_diseño(con, username, diseño);
                        ...
                        case 3: System.out.println("Digite la base de su objeto en metros: ");
                            ...
                            Item item = new Item(baseItem, alturaItem, profundidadItem, "Hola");
                            servItem.guardar_item(con, username, item);
                            break;
                                    ...
                                    do{
                                        switch (datoactualizar) {
                                            case 1:
                                                ...
                                                servUsuario.actualizar_usuario(con, newusername, username);
                                            ...
                                            case 2:
                                                ...
                                                servUsuario.actualizar_password(con, newcontraseña, password);
                                                System.out.println("Actualización exitosa");
                                                datoactualizar= 70;
                                                break;
                                            case 3:
                                                ...
                                                servUsuario.actualizar_email(con, newemail, servUsuario.getEmail(con, username));
                                                System.out.println("Actualización exitosa");
                                                datoactualizar= 70;
                                                break;
                                            case 4:
                                                ...
                                                servUsuario.actualizar_nombres(con, newnombres, servUsuario.getNombres(con, username));
                                                System.out.println("Actualización exitosa");
                                                datoactualizar= 70;
                                                break;
                                            case 5:
                ...
                servUsuario.guardar_usuario(con, newuser);
